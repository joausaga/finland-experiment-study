...
After finnishing the experince, the main factor, that seems to drove participants' decision to take part in the process, is the interest of getting to know other's point of view regarding the condominum law. With a interestly high mean score of **`r round(means_q9_s2[8],2)`**, this factor has been pointed, in the last survey, as the biggest reason that triggered participation. Without beign included in the pre-experience survey, it turns out that after taken part of the process participants had gotten enriched so much from each other's point of views that assessed this factor as the main cause that drove their decisions to participate.
